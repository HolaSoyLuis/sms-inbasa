   					...
   					<div class="card-content">
  						...
  						<h6 class="category text-muted">WEB DEVELOPER Y DESIGNER</h6>
   						<p class="card-description">
  							Desarrollador Web amante de los sistemas, la seguridad informática y el material design web.
  						</p>
  						<div class="footer">
						  <a href="https://twitter.com/wulmdeleon" class="btn btn-just-icon btn-simple btn-twitter" target="_blank"><img src="{{ asset('img/social/twitter.svg')}}" alt="tw" class="img-social"></a>
   							<a href="https://www.facebook.com/wiudleonm" class="btn btn-just-icon btn-simple btn-facebook" target="_blank"><img src="{{ asset('img/social/facebook.svg')}}" alt="fb" class="img-social"></a>
   							<a href="https://www.linkedin.com/in/wiudleonm/" class="btn btn-just-icon btn-simple btn-linkedin" target="_blank"><img src="{{ asset('img/social/linkedin.svg')}}" alt="ln" class="img-social"></a>
   						</div>
   					</div>
   				</div>
            </div>
