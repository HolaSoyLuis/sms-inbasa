	...
	<div class="row justify-content-center">	
		<div class="col">
 		...
 		<div class="form-row">  {{--Contenedor Primera Fila--}}		
				...
				<div class="col">  {{--Primera Columna --}}	
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="text" class="form-control" name="p_nombre" input id="p_nombre"></input>
				...
				<div class="col"> {{-- Segunda Columna --}}
								...
								<input type="text" class="form-control" name="s_nombre" input id="s_nombre"></input>
				...
				<div class="col"> {{-- Tercera Columna --}}
								...
								<input type="text" class="form-control" name="p_apellido" input id="p_apellido"></input>
				...
				<div class="col"> {{-- Cuarta Columna --}}
					...
					<div class="form-group label-floating">								
								...
								<input type="text" class="form-control" name="s_apellido" input id="s_apellido"></input>
			...
			<div class="col">  {{--Primera Columna --}}	
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="text" class="form-control" name="cui" input id="cui"></input>
								@if ($errors->has('cui'))
										<span class="invalid-feedback" role="alert">
				...
				<div class="col">  {{--Primera Columna --}}	
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="text" class="form-control" name="genero" input id="genero"></input>
				...
				<div class="col">  {{--Segunda Columna --}}	
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="date" class="form-control" name="fecha_nac" input id="fecha_nac"></input>
		...
		<div class="form-row">  {{--Contenedor Cuarta Fila--}} 
					...
					<div class="col"> {{-- Primera  Columna --}}
								...
								<input type="text" class="form-control" name="lugar_nac" input id="lugar_nac"></input>
					...
					<div class="col"> {{-- Segunda Columna --}}
								...
								<input type="text" class="form-control" name="estado_civil" input id="estado_civil"></input>
