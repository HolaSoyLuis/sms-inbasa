	...
	<div class="row justify-content-center">	
		<div class="col-md-4">
			<div class="card">
				...
				<form method="post" action="{{ route('bloques.update', $bloques->id) }}">
					@method('PUT')
					@csrf
					<h3>Ingrese los Datos</h3>		
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="char" class="form-control" value="{{ $bloques->bloque }}" name="bloque" id="bloque">
						...
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="number" class="form-control" value="{{ $bloques->nota_min }}" name="nota_min" id="nota_min">
						...
						<div class="form-group">
							<div class="form-group label-floating">								
								...
								<input type="number" class="form-control" value="{{ $bloques->nota_max }}" name="nota_max" id="nota_max">
